...
export async function search(request: SearchRequest): Promise<SearchResponse> {
  ...
  const allResults: SearchResult[] = [
    { id: '1', type: 'case', title: primaryCase.title, description: `Case #${primaryCase.caseNumber} — ${primaryCase.jurisdiction}, ${primaryCase.court}`, url: `/app/cases/${primaryCase.id}/overview` },
    { id: '2', type: 'case', title: secondaryCase.title, description: `Case #${secondaryCase.caseNumber} — ${secondaryCase.jurisdiction}, ${secondaryCase.court}`, url: `/app/cases/${secondaryCase.id}/overview` },
    { id: '3', type: 'document', title: 'Motion to Suppress Evidence', description: 'Filed Jan 20, 2024 — Defense Motion — 8 pages', url: `/app/cases/${primaryCase.id}/documents` },
    { id: '4', type: 'document', title: 'Criminal Complaint', description: 'Filed Dec 15, 2023 — Charging Document — 4 pages', url: `/app/cases/${primaryCase.id}/documents` },
    { id: '5', type: 'document', title: 'Preliminary Hearing Transcript', description: 'Filed Jan 18, 2024 — Transcript — 45 pages', url: `/app/cases/${primaryCase.id}/documents` },
