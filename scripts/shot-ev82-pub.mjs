...
const U='https://eric-collaborative-pmid-safari.trycloudflare.com'; const OUT='reports/screenshots/evidence-p82';
...
await pg.goto(U+'/cases/'+CID+'/evidence',{waitUntil:'networkidle',timeout:30000}).catch(()=>{});await pg.waitForTimeout(2800);
await pg.screenshot({path:OUT+'/public-evidence.png'});console.log('public evidence shot done');
await b.close();
