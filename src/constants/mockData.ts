...
export const MOCK_DOCUMENTS: DocumentEntity[] = [
  ...
  { id: '2', tenantId: 'tenant-001', caseId: '1', name: 'Criminal Complaint', type: 'charging_document', filedDate: 'Dec 15, 2023', pages: 4, analysisStatus: 'analyzed', fileSize: 122880, fileType: 'pdf', contentHash: 'sha256:b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3d4e5f6a1b2c3', uploadedBy: null, uploadedAt: '2023-12-15T08:00:00Z', storagePath: '/documents/tenant-001/case-1/2-criminal-complaint.pdf', extractedText: null, extractionStatus: 'pending', integrityVerified: false },
