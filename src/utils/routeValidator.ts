...
export const ROUTE_REGISTRY: RouteDefinition[] = [
  ...
  { path: '/cases/:caseId/investigator-workbench', label: 'Investigator Workbench', requiresAuth: true, requiredPermission: 'canViewEvidence', component: 'InvestigatorWorkbenchPage', status: 'active' },
