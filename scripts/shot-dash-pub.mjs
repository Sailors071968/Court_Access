...
const U='https://eric-collaborative-pmid-safari.trycloudflare.com'; const OUT='reports/screenshots/dashboard-p80';
...
await pg.goto(U+'/dashboard',{waitUntil:'networkidle',timeout:30000}).catch(()=>{});await pg.waitForTimeout(3000);
await pg.screenshot({path:OUT+'/public-dashboard.png'});console.log('public dashboard shot done');
await b.close();
