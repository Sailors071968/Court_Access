...
const BASE='http://localhost:8090'; const OUT='reports/screenshots/dashboard-p80';
...
await pg.goto(BASE+'/dashboard',{waitUntil:'networkidle',timeout:25000}).catch(()=>{});await pg.waitForTimeout(3000);
await pg.screenshot({path:OUT+'/dashboard.png',fullPage:true});
