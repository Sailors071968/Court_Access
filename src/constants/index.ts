...
export const ROLE_PERMISSIONS: Record<UserRole, RolePermissions> = {
  investigator: {
    ...
    canViewAdmin: false,
    canViewEvidenceManagement: false,
    canViewTasks: true,
  ...
  admin: {
    ...
    canManageCases: true,
    canViewAdmin: true,
    canViewEvidenceManagement: true,
    canViewTasks: true,
    canViewSettings: true,
  },
  staff: {
...
export const CASE_TABS = [
  ...
  { id: 'motions', label: 'Motion Builder', path: '/motions', permission: 'canViewMotions' as const },
  ...
  { id: 'report', label: 'Attorney Report', path: '/report', permission: 'canViewEvidence' as const },
  { id: 'reports', label: 'Reports', path: '/reports', permission: 'canViewEvidence' as const },
  { id: 'trial-prep', label: 'Trial Prep', path: '/trial-prep', permission: 'canViewEvidence' as const },
  { id: 'calcrim', label: 'CALCRIM', path: '/calcrim', permission: 'canViewEvidence' as const },
  { id: 'voir-dire', label: 'Voir Dire', path: '/voir-dire', permission: 'canViewEvidence' as const },
  { id: 'sentencing', label: 'Sentencing', path: '/sentencing', permission: 'canViewEvidence' as const },
