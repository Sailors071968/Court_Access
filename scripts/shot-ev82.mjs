...
const BASE='http://localhost:8090'; const OUT='reports/screenshots/evidence-p82';
...
await pg.goto(BASE+'/cases/'+CID+'/evidence',{waitUntil:'networkidle',timeout:25000}).catch(()=>{});await pg.waitForTimeout(2800);
await pg.screenshot({path:OUT+'/evidence.png',fullPage:true});
