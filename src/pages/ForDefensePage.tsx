...
function DefenseFeatureCard({ icon: Icon, title, description, items }: DefenseFeatureProps) {
  return (
    <div className="bg-white/5 rounded-2xl shadow-md border border-white/10 p-8 hover:shadow-lg transition-shadow">
      ...
      <p className="text-slate-300 mb-5 leading-relaxed">{description}</p>
    ...
    <section className="py-20 bg-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div key={t.author} className="bg-white/5 rounded-2xl shadow-md border border-white/10 p-8">
              ...
              <p className="text-sm font-semibold text-white">&mdash; {t.author}</p>
            </div>
          ))}
        </div>
      </div>
