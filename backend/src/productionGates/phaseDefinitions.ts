...
export const MASTER_PRODUCTION_PHASES: ProductionPhase[] = [
  {
    ...
    capabilities: [
      ...
      capFn('P01-04', 'MFA', async () => false, 'MFA not implemented'),
      cap('P01-05', 'Session management', 'backend/src/security/authMiddleware.ts'),
      capFn('P01-06', 'Device management', async () => false, 'Device management not implemented'),
      capFn('P01-07', 'Email verification', async () => false, 'Email verification not implemented'),
  ...
  },
  {
    ...
    capabilities: [
      ...
      capFn('P02-05', 'Client communications', async () => false, 'Client messaging not implemented'),
      capFn('P02-06', 'Court reminders', async () => false, 'Court reminders not implemented'),
  ...
  },
  {
    ...
    capabilities: [
      ...
      capFn('P03-03', 'Hearings & calendar', async () => {
        const schema = await fileExists(workspacePath('backend/prisma/schema.prisma'));
        return schema;
      }),
  ...
  },
  {
    ...
    capabilities: [
      ...
      capFn('P11-02', 'Secure messaging', async () => false, 'Secure messaging not implemented'),
      capFn('P11-03', 'Court dates', async () => false, 'Client court dates view not implemented'),
  ...
  },
  {
    ...
    capabilities: [
      ...
      capFn('P14-03', 'Secure messaging', async () => false, 'Secure messaging not implemented'),
  ...
  },
  {
    ...
    capabilities: [
      ...
      capFn('P17-06', 'MFA', async () => false, 'MFA not implemented'),
