...
const U='https://eric-collaborative-pmid-safari.trycloudflare.com'; const OUT='reports/screenshots/kg';
...
await pg.goto(U+'/cases/'+CID+'/knowledge-graph',{waitUntil:'networkidle',timeout:30000}).catch(()=>{});await pg.waitForTimeout(3500);
await pg.screenshot({path:OUT+'/public-kg-home.png'});console.log('public kg shot done');
await b.close();
