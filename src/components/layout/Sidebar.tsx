...
import {
  ...
  FileText, Tag, Upload, BarChart3, Globe, Activity, Server, BookOpen, CheckSquare, Video,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'video-processing', label: 'Video Processing', path: '/dashboard/video-processing', icon: <Video size={16} /> },
    ],
  },
];
