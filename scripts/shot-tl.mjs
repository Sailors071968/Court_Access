...
const BASE='http://localhost:8090'; const OUT='reports/screenshots/timeline'; const CID='46f6002a-cb7b-4ad5-a3bc-967c88eeebe7';
...
await pg.goto(BASE+'/cases/'+CID+'/timeline',{waitUntil:'networkidle',timeout:25000}).catch(()=>{});await pg.waitForTimeout(3000);
await pg.screenshot({path:OUT+'/timeline-home.png',fullPage:true});
console.log('timeline shot');
