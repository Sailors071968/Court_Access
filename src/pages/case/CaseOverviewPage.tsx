...
import { FileText, Scale, Calendar, Lightbulb, MapPin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <StatCard icon={<Scale size={28} className="text-amber-600" />} value={currentCase.chargesCount} label="Charges Pending" />
        ...
        <StatCard icon={<Lightbulb size={28} className="text-amber-500" />} value="8 New" label="AI Insights" highlight />
        <StatCard icon={<MapPin size={28} className="text-amber-500" />} value="8 New" label="AI Insights" highlight />
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => navigate(`/cases/${caseId}/documents`)} className="text-sm text-blue-600 hover:text-blue-700 font-medium">View all</button>
            </div>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              The prosecution's motion to exclude alibi witnesses may significantly impact your defense strategy. Review with your attorney.
            </p>
            <button onClick={() => navigate(`/cases/${caseId}/charges`)} className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-amber-50 text-amber-700 rounded-lg text-sm font-medium hover:bg-amber-100 transition-colors">
              View Full Analysis
            </button>
          </Card>
