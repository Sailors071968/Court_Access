...
const U='https://eric-collaborative-pmid-safari.trycloudflare.com'; const OUT='reports/screenshots/overview-p81';
...
await pg.goto(U+'/cases/'+CID+'/overview',{waitUntil:'networkidle',timeout:30000}).catch(()=>{});await pg.waitForTimeout(3000);
await pg.screenshot({path:OUT+'/public-overview.png'});console.log('public overview shot done');
await b.close();
