...
export const MOCK_DOCUMENTS: DocumentEntity[] = [
  { id: '1', tenantId: 'tenant-001', caseId: '1', name: 'Motion to Suppress Evidence', type: 'defense_motion', filedDate: 'Jan 20, 2024', pages: 8, analysisStatus: 'analyzed', fileSize: null, fileType: 'pdf', contentHash: null, uploadedBy: '1', uploadedAt: '2024-01-20T10:00:00Z' },
  { id: '2', tenantId: 'tenant-001', caseId: '1', name: 'Criminal Complaint', type: 'charging_document', filedDate: 'Dec 15, 2023', pages: 4, analysisStatus: 'analyzed', fileSize: null, fileType: 'pdf', contentHash: null, uploadedBy: null, uploadedAt: '2023-12-15T08:00:00Z' },
  { id: '3', tenantId: 'tenant-001', caseId: '1', name: 'Preliminary Hearing Transcript', type: 'transcript', filedDate: 'Jan 18, 2024', pages: 45, analysisStatus: 'analyzed', fileSize: null, fileType: 'pdf', contentHash: null, uploadedBy: null, uploadedAt: '2024-01-18T14:00:00Z' },
  { id: '4', tenantId: 'tenant-001', caseId: '1', name: 'Motion to Exclude Witness Testimony', type: 'prosecution_motion', filedDate: 'Jan 22, 2024', pages: 6, analysisStatus: 'analyzing', fileSize: null, fileType: 'pdf', contentHash: null, uploadedBy: null, uploadedAt: '2024-01-22T09:00:00Z' },
  { id: '5', tenantId: 'tenant-001', caseId: '1', name: 'Arraignment Minutes', type: 'court_order', filedDate: 'Dec 20, 2023', pages: 2, analysisStatus: 'analyzed', fileSize: null, fileType: 'pdf', contentHash: null, uploadedBy: null, uploadedAt: '2023-12-20T11:00:00Z' },
  { id: '6', tenantId: 'tenant-001', caseId: '1', name: 'Discovery Request Response', type: 'defense_filing', filedDate: 'Jan 10, 2024', pages: 12, analysisStatus: 'analyzed', fileSize: null, fileType: 'pdf', contentHash: null, uploadedBy: '1', uploadedAt: '2024-01-10T16:00:00Z' },
];
