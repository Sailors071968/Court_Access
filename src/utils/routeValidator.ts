...
export const ROUTE_REGISTRY: RouteDefinition[] = [
  ...
  { path: '/dashboard/policy-intelligence', label: 'Policy Intelligence', requiresAuth: true, requiredPermission: 'canViewAdmin', component: 'PolicyIntelligenceDashboard', status: 'active' },
  ...
  { path: '/dashboard/cpra-tracker', label: 'CPRA Tracker', requiresAuth: true, requiredPermission: 'canViewAdmin', component: 'CpraDashboard', status: 'active' },
